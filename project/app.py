...
'''
какие параметры принимает объект page и что он создаёт
что такое data frame и зачем он тут нужен 
процесс создания графика и процесс размещения его в приложении в коде питона
'''
